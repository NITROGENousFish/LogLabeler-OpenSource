...
class Preprocessor:
    ...
    def process(self, dataset, parsing, template_encoding, cut_func): # -> Tuple[List[Instance], List[Instance], List[Instance]]:
        '''
    ...
    def update_dicts(self):
        ...
        self.templates = self.dataloader.templates #* drain dicts
